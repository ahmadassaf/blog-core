...
class SNARCSearch {
	...
	function build($document) {
		...
		$documentSearchResult = $documentSearch->build($document->url, $document->zemantaPosts,$document->keywords);
		...
		return array_merge($documentSearchResult,$videoSearchResult,$stackoverflowResult,$googlePlusResult,$twitterSearchResult);
	}
}
