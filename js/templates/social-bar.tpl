	...
	<li class="snarcStream-micropost{{if service == 'twitter'}} snarcStream-tweet {{/if}}" id="${link}">
		...
		<div class="snarcStream-infoBar">
			<span class="snarcStream-info">
				{{if service == 'twitter'}} <i class="icon-twitter"></i>{{if program }}&nbsp;via {{html program}} {{/if}} {{/if}}
				{{if service == 'google'}} 
					<i class="icon-google"></i>&nbsp;${time} 
				{{/if}}
			</span>
			{{if service == 'google'}}
				<span class="snarcStream-expand snarc-popup"><a class="icon-dots" target="_blank" href="${link}"></a></span>
			{{/if}}
			{{if service == 'twitter'}}
				<div class="snarcStream-intents snarc-popup">
...
{{else type === "slide"}}
	<li class="snarcStream-slide">
		...
		<div class="snarcStream-bottom_bar">
			...
			<a href="${link}" class="snarcStream-expand"><i class="icon-dots"></i></a>
		</div>
	</li>
{{else type === "video"}}
